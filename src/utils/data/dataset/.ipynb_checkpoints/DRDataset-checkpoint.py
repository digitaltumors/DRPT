    ...
    def __call__(self, data):
        ...
        for genotype in self.genotypes:
            if self.with_indices:
                embedding_dict = {}
                if self.mut2gene:
                    #NOTE: On 3/19/2025 I found that padding_value was set to n_genes-1. I believe this is wrong, and if I recall I set this to n_genes-1 thinking it was fixing
                    # an indexing error I was getting. I'm worried this is now a small bug in the model. For now, leave as is, but come by to assess and/or speak with Ingoo.
